...
export const SummarySection = memo(
  ({ dailyLimit, spentToday, isDarkMode = true, onEdit }: SummarySectionProps) => (
    <section className="transform-gpu">
      <div className="flex items-center gap-3 mb-6 px-1">
        <div className="flex items-center gap-2">
          {/* Dekorasi indikator tetap kita pertahankan untuk estetika */}
          <div
            className={`w-1 h-3 bg-emerald-500 rounded-full transition-shadow ${
              isDarkMode ? "shadow-[0_0_8px_rgba(16,185,129,0.6)]" : "shadow-none"
            }`}
          />
          <h3
        ...
        <div
          className={`h-[1px] flex-grow bg-gradient-to-r transition-colors duration-500 ${
