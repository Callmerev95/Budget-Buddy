...
import type { TransactionListItem } from "@budget-buddy/shared";
    ...
    <section className="transform-gpu">
      ...
      <div className="flex items-center justify-between mb-6 px-1">
        <div className="flex items-center gap-2 flex-grow">
          ...
          <h3
            className={`text-xs font-black tracking-[0.3em] uppercase whitespace-nowrap transition-colors duration-500 ${
          ...
          <div
            className={`h-[1px] flex-grow ml-2 transition-all duration-500 bg-gradient-to-r ${
        ...
        <div
          className={`flex items-center gap-2 border rounded-xl px-3 py-1.5 ml-4 shadow-sm transform-gpu active:scale-95 transition-all duration-500 ${
            isDarkMode
