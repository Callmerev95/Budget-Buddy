...
export const BalanceCard = memo(
  ({
    ...
    const statusNote = isDanger
      ? "⚠️ Pengeluaran Melebihi Batas"
      : isWarning
        ? "🧐 Perlu Kendali Extra"
        : "🛡️ Pengeluaran Terkendali";
    ...
    return (
      <motion.div
        ...
        className={`relative overflow-hidden p-7 rounded-[2.5rem] border transition-all duration-500 transform-gpu ${
          isDarkMode
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-center mb-5">
            ...
            <div
              className="px-3 py-1.5 rounded-xl border text-[9px] font-black uppercase tracking-tighter transition-colors duration-500"
              style={{
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0 flex items-baseline gap-2">
              <span
                className={`text-2xl font-black tracking-tighter italic flex-shrink-0 ${
              ...
              <div className="relative overflow-hidden flex-1">
                <AnimatePresence mode="wait">
                  {isVisible ? (
                    ...
                    >
                      {formatAmount(Math.abs(remainingLimit))}
                    </motion.h2>
                  ) : (
                    <motion.h2
                      key="hidden"
                      ...
                      exit={{ y: -20, opacity: 0 }}
                      transition={{ type: "tween", ease: "easeOut", duration: 0.2 }}
                      className={`text-5xl font-black tracking-[0.15em] leading-tight ${
            ...
            <button
              ...
              className={`flex-shrink-0 p-3 rounded-2xl transition-all border ${
                isDarkMode
            ...
            <div className="mt-10">
              <div className="flex justify-between items-end mb-3 px-1">
                <div>
                  ...
                  <p
                    className={`text-sm font-black ${isDarkMode ? "text-zinc-200" : "text-zinc-700"}`}
                  >
                    {statusNote}
                  </p>
                </div>
                <div className="text-right">
                  <p
                    className={`text-lg font-black tracking-tighter ${isDarkMode ? "text-white" : "text-zinc-900"}`}
                  >
              ...
              <div
                className={`w-full h-3.5 rounded-full overflow-hidden p-1 border shadow-inner relative ${
                  isDarkMode
        ...
        <div
          className="absolute -right-16 -bottom-16 w-48 h-48 rounded-full blur-[100px] opacity-10 transition-colors duration-700"
          style={{ backgroundColor: accentColor }}
        />
      </motion.div>
    );
