...
export const SummaryGrid = memo(
  ({ dailyLimit, totalSpent, onEditLimit, isDarkMode = true }: SummaryGridProps) => {
    return (
      <div className="grid grid-cols-2 gap-4 mb-8 transform-gpu">
        ...
        >
          <div
            className={`p-5 rounded-[2.25rem] border text-left transition-all duration-500 h-full ${
              isDarkMode
          ...
          >
            <div className="flex justify-between items-start mb-4 relative z-10">
              ...
              <div
                className={`p-1 transition-opacity ${isDarkMode ? "opacity-40" : "opacity-30"}`}
              >
                <ChevronRight
                  size={14}
                  className={isDarkMode ? "text-emerald-500" : "text-emerald-600"}
                />
              </div>
            </div>
              ...
              <div className="flex items-baseline gap-1">
                <span
                  className={`text-[10px] font-bold transition-colors ${
                    isDarkMode ? "text-emerald-500/40" : "text-emerald-600/60"
                  }`}
                >
                  Rp
                </span>
                <p
                  className={`text-xl font-black leading-none tracking-tighter transition-colors duration-500 ${
        ...
        <div className="relative overflow-hidden transform-gpu">
          ...
          >
            <div
              className={`w-10 h-10 rounded-2xl flex items-center justify-center mb-4 transition-all duration-500 relative z-10 ${
            ...
            <div className="space-y-1 relative z-10">
              ...
              <div className="flex items-baseline gap-1">
                <span
                  className={`text-[10px] font-bold transition-colors ${
                    isDarkMode ? "text-rose-500/40" : "text-rose-600/60"
                  }`}
                >
                  Rp
                </span>
