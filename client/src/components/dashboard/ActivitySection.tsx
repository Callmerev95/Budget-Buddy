...
export const ActivitySection = memo(({ selectedDate, onDateChange, transactions, onDelete }: ActivitySectionProps) => (
  <section className="transform-gpu"> {/* Tambah GPU layer */}
    <div className="flex items-center justify-between mb-6 px-1">
      ...
      {/* Input date dengan optimasi GPU */}
      <div className="flex items-center gap-2 bg-zinc-900 border border-white/5 rounded-xl px-3 py-1.5 ml-4 shadow-sm transform-gpu active:scale-95 transition-transform">
        ...
        <input
          ...
          style={{ colorScheme: 'dark' }} // Biar picker-nya ikut tema dark browser
        />
      </div>
    </div>

    {/* TransactionList sudah kita memo sebelumnya, jadi ini bakal aman banget */}
