  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <p className="text-zinc-500 text-sm mt-2">Cara asik jaga dompet tetap aman!</p>
      </div>
      ...
      <div className="text-center mt-8">
        <p className="text-zinc-500 text-sm">
          Belum bergabung? {' '}
          <Link to="/register" className="text-emerald-500 font-bold hover:text-emerald-400 transition-colors">Buat Akun Baru</Link>
        </p>
      </div>
    </motion.div>
  );
